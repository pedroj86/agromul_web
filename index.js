...
const myParcelsLayer = L.layerGroup().addTo(map); // Inicializa como vacío
...
// Obtener todas las parcelas y recintos del usuario actual
...
document.getElementById('my-parcels-layer').addEventListener('change', function () {
  if (this.checked) {
    // Cargar y mostrar mis parcelas (ejemplo)
